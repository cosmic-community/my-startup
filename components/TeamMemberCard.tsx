...
export default function TeamMemberCard({ member }: TeamMemberCardProps) {
  ...
  const twitterUrl = getMetafieldValue(member.metadata?.twitter_url)

  return (
    <div className="group bg-white rounded-2xl overflow-hidden border border-gray-100 card-hover">
      <div className="aspect-square bg-gradient-to-br from-primary-100 to-accent-100 relative overflow-hidden">
        {headshot?.imgix_url ? (
          <img
      ...
      <div className="p-6">
        ...
        {bio && (
          <p className="text-gray-500 text-sm leading-relaxed line-clamp-3 mb-4">{bio}</p>
        )}
